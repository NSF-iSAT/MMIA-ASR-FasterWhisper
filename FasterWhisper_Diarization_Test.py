...
def record_chunk(p, stream, file_path, chunk_length=3):
    """
    Function that retrives that recorded audio of length "chunk_length", saves it in file_pat and returns the audio in numpy format.
    """
    frames=[]
...
class SpeakerDiarization:
    ...
    def getResults(self, audio):
        ...
        dists = pairwiseDists(embsNorm, self.clustersNorm) # Find the cosine distance for the new audio to every cluster center. Length will be number of clusters.
...
def main():
    ...
    # Initialze the diarizer with enrollments
    ...
    try:
        while True:
            ...
            chunk_length=10 # Define the frequency of recording in seconds
            ...
            # Unpack the segments and diarize individually. 
            for segment in segments:
                ...
                #Calculate the dominant speaker by Weighted Vote method
